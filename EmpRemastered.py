...
# clear home layout
def placeForgot():
    FindEmp.place_forget()
    UpdateBtn.place_forget()
    SalCalBtn.place_forget()
    AddBtn.place_forget()
    RmBtn.place_forget()

# assigning hoe layout
def homePlace():
...
def Btn1Frame():
    ...
    EmpLabel = Label(MainFrame,image=HeadImg,background="#121210")
    EmpLabel.pack()

    entry_employee_id = tk.Entry(MainFrame,width="50",font=10,fg="gray")
    entry_employee_id.place(x=130,y=65)
    entry_employee_id.insert(0,"Enter Employee ID")
    entry_employee_id.bind("<FocusIn>", click)

    search_button = tk.Button(MainFrame, image=SearchImg, bg="#121210",command=search_employee,borderwidth=0,relief="flat",activebackground="#121210")
    search_button.place(x=580,y=64,width=28,height=24)

    display_button = tk.Button(MainFrame,image=WholeTImg, bg="#121210",borderwidth=0,relief="flat",activebackground="#121210", command=display_employee)
    display_button.place(x=30,y=50)

    tree = ttk.Treeview(MainFrame, columns=("ID", "Name", "Gender", "Age", "Department","Job Position" ,"Date of Joining", "Salary"),height=10)
    ...
    alterLab = Label(MainFrame,text="Empty Table",height="10",width="100",font=('Arial',15),bg="#121210",fg="white")
    alterLab.pack()
    alterLab.pack_forget()
...
def AddEmp():
    ...
    placeForgot()
    HeadLabel.pack_forget()

    label_employee_id = tk.Label(MainFrame, text="Enter Employee ID:",font=(15),bg="#121210",fg="white")
    label_employee_id.place(x=100,y=20)
    entry_employee_id = tk.Entry(MainFrame,width="30",font=(15))
    entry_employee_id.place(x=335,y=20)

    label_employee_name = tk.Label(MainFrame, text="Enter Employee Name:",font=(15),bg="#121210",fg="white")
    label_employee_name.place(x=100,y=60)
    entry_employee_name = tk.Entry(MainFrame,width="30",font=(15))
    entry_employee_name.place(x=335,y=60)

    label_employee_age = tk.Label(MainFrame, text="Enter Employee Age:",font=(15),bg="#121210",fg="white")
    label_employee_age.place(x=100,y=100)
    entry_employee_age = tk.Entry(MainFrame,width="30",font=(15))
    entry_employee_age.place(x=335,y=100)

    label_employee_gender = tk.Label(MainFrame, text="Select Employee Gender:",font=(15),bg="#121210",fg="white")
    label_employee_gender.place(x=100,y=140)
    select_gender = tk.StringVar()
    entry_employee_gender = ttk.Combobox(MainFrame, textvariable=select_gender, font=(8),state="readonly")
    entry_employee_gender["values"] = ("MALE","FEMALE")
    entry_employee_gender.place(x=335,y=140)

    label_employee_email = tk.Label(MainFrame, text="Enter Employee Email:",font=(15),bg="#121210",fg="white")
    label_employee_email.place(x=100,y=180)
    entry_employee_email = tk.Entry(MainFrame,width="30",font=(15))
    entry_employee_email.place(x=335,y=180)

    label_employee_address = tk.Label(MainFrame, text="Enter Employee Address:",font=(15),bg="#121210",fg="white")
    label_employee_address.place(x=100,y=220)
    entry_employee_address = tk.Entry(MainFrame,width="30",font=(15))
    entry_employee_address.place(x=335,y=220)

    label_employee_doj = tk.Label(MainFrame, text="Enter Date of Joining:",font=(15),bg="#121210",fg="white")
    label_employee_doj.place(x=100,y=260)
    entry_employee_doj = tk.Entry(MainFrame,width="30",font=(18),fg="gray")
    entry_employee_doj.insert(0,"(YYYY-MM-DD)")
    entry_employee_doj.bind("<FocusIn>", click)
    entry_employee_doj.place(x=335,y=260)

    label_deparment_name = tk.Label(MainFrame, text="Select Deparment Name:",font=(15),bg="#121210",fg="white")
    label_deparment_name.place(x=100,y=300)
    selected_dept = tk.StringVar()
    entry_deparment_name = ttk.Combobox(MainFrame,textvariable=selected_dept,font=(8))
    ...
    label_job_position = tk.Label(MainFrame, text="Select Job Role:",font=(15),bg="#121210",fg="white")
    label_job_position.place(x=100,y=340)
    selected_role = tk.StringVar()
    entry_job_position = ttk.Combobox(MainFrame,textvariable=selected_role,font=(8))
    ...
    add_button = tk.Button(MainFrame, image=InsBtnImg, bg="#121210",command=add_employee,borderwidth=0,activebackground="#121210")
    add_button.place(x=300,y=390)

    label_result = tk.Label(MainFrame, text="",font=(18),bg="#121210",fg="white")
...
def RmBtn():
    ...
    label_employee_id = tk.Label(MainFrame, image=HeadImg,bg="#121210")
    ...
    SearchImg = ImageTk.PhotoImage(Image.open(r"E:\pbl\pbl\frame0\SBtn.png"))
    search_button = tk.Button(MainFrame, image=SearchImg, bg="#121210",activebackground="#121210",borderwidth=0,command=search_employee)
    search_button.place(x=580,y=64,width=28,height=24)
    delImg = ImageTk.PhotoImage(Image.open(r"E:\pbl\pbl\frame0\RBtn.png"))
    delete_button = tk.Button(MainFrame,image=delImg, bg="#121210", activebackground="#121210",borderwidth=0, command=delete_employee)
    delete_button.place(x=325,y=300)

    tree = ttk.Treeview(MainFrame, columns=("ID", "Name", "Gender", "Age", "Department","Job Position" ,"Date of Joining", "Salary"),height=1)
    tree.heading("ID", text="ID")
    tree.heading("Name", text="Name")
    tree.heading("Gender", text="Gender")
    tree.heading("Age", text="Age")
    ...
    text_employee_details = tk.Label(MainFrame,background="#121210",font=('Arial',15),fg="white")
...
def UpdFun():
    ...
    tree = ttk.Treeview(MainFrame, columns=("ID", "Name", "Age","Email","Address", "Dept", "Job"),height=1)
    tree.heading("ID", text="ID")
    tree.heading("Name", text="Name")
    tree.heading("Age", text="Age")
    ...
    alterLab = Label(MainFrame,text="Empty Table",font=('Arial',18),bg="#121210",fg="white")
    alterLab.pack()
    alterLab.pack_forget()
    # personal btn declaring
    PerImg = ImageTk.PhotoImage(Image.open(r"E:\pbl\pbl\frame0\PerDtl.png"))
    PerBtn = tk.Button(MainFrame,image=PerImg,activebackground="#121210",borderwidth=0,command=PerUpd,background="#121210")
    PerBtn.place(x=100,y=200)
    PerBtn.place_forget()
    # professional btn declaring
    ProfImg = ImageTk.PhotoImage(Image.open(r"E:\pbl\pbl\frame0\ProDtl.png"))
    ProfBtn = tk.Button(MainFrame,image=ProfImg,activebackground="#121210",command=ProfUpd,borderwidth=0,background="#121210")
    ProfBtn.place(x=550,y=200)
    ProfBtn.place_forget()
    # Personal btn define
    empNameLab = tk.Label(MainFrame,text="Enter Employee Name:",background="#121210",font=(15),fg="white")
    empNameLab.pack_forget()

    empName = tk.Entry(MainFrame,width=20,font=(16))
    empName.pack_forget()

    empAddressLab = tk.Label(MainFrame,text="Enter Employee Address:",background="#121210",font=(15),fg="white")
    empAddressLab.pack_forget()

    empAddress = tk.Entry(MainFrame,width=20,font=(16))
    empAddress.pack_forget()

    empMailLab = tk.Label(MainFrame,text="Enter Employee Email:",background="#121210",font=(15),fg="white")
    empMailLab.pack_forget()

    empMail = tk.Entry(MainFrame,width=20,font=(16))
    empMail.pack_forget()

    empAgeLab = tk.Label(MainFrame,text="Enter Employee Age:",background="#121210",font=(15),fg="white")
    empAgeLab.pack_forget()
    selected_Age = tk.IntVar()
    AgeCombo = ttk.Combobox(MainFrame,textvariable=selected_Age)
    value=[]
    ...
    empDeptLab = tk.Label(MainFrame,text="Enter Employee Department:",background="#121210",font=(15),fg="white")

    selected_dept = tk.StringVar()
    DeptCombo = ttk.Combobox(MainFrame,textvariable=selected_dept)
    DeptCombo["values"] = employees
    DeptCombo['state'] = "readyonly"


    empRoleLab = tk.Label(MainFrame,text="Enter Employee Job role:",background="#121210",font=(15),fg="white")
    empRoleLab.place_forget()

    selected_jobs = tk.StringVar()
    empRole  =ttk.Combobox(MainFrame,textvariable=selected_jobs)
    empRole['values'] = jobs
    ...
    UpdBtn1 = tk.Button(MainFrame,image=UpdImg,background="#121210",activebackground="#121210",command=updBtnF1,borderwidth=0)
    UpdBtn2 = tk.Button(MainFrame,image=UpdImg,background="#121210",activebackground="#121210",command=updBtnF2,borderwidth=0)
    MainFrame.mainloop()
...
def SalCalFun():
    ...
    TotalCombo = ttk.Combobox(MainFrame,textvariable=selectedTDays)
    TotalDay=[]
    ...
    WorkDay = tk.Entry(MainFrame,font=(18),width=10)

    search_button = tk.Button(MainFrame, image=SearchImg, bg="#121210",command=search_employee,borderwidth=0,relief="flat",activebackground="#121210")
    search_button.place(x=580,y=64,width=28,height=24)
    
    CalBtn = tk.Button(MainFrame, image=CalImg, bg="#121210",command=CalBtnFun,borderwidth=0,relief="flat",activebackground="#121210")


    TotalWorkLab = tk.Label(MainFrame,text="Enter Total working Days(for this Month):",font=(15),bg="#121210",fg="white")
    PresentWorkLab = tk.Label(MainFrame,text="Enter Employee Present Days:",font=(15),bg="#121210",fg="white")

    tree = ttk.Treeview(MainFrame, columns=("ID", "Name", "Job" ,"Salary"),height=1)
    tree.heading("ID", text="ID")
    tree.heading("Name", text="Name")
    tree.heading("Job",text="Job role")
    tree.heading("Salary", text="Salary")
    ...
    alterLab = tk.Label(MainFrame,text="Empty Table",font=('Arial',18),bg="#121210",fg="white")
    alterLab.pack()
    alterLab.pack_forget()
    MainFrame.mainloop()
